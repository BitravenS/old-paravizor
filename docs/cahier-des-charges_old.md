...
Paravizor est concu comme une plateforme de reconnaissance offensive pour le bug bounty, orientee automatisation, pilotage humain et extensibilite.
...
1. **Controlabilite** : l'utilisateur garde la maitrise des decisions.
2. **Traçabilite** : chaque resultat doit pouvoir etre relie a son origine.
3. **Evolutivite** : pipelines, outils et strategies doivent pouvoir evoluer rapidement.
...
4. **Triage et priorisation**
   - les resultats utiles sont filtres et classes,
...
- une lisibilite elevee meme sur sessions longues.
...
- possibilite de desactivation complete,
- parametrage du fournisseur et du mode de consentement,
- protection des donnees sensibles.

## 8.4 Critere cle de succes IA

L'IA est consideree utile si elle **ameliore concretement la vitesse et la qualite des decisions**, sans generer de dependance aveugle ni de bruit supplementaire.
...
- fonctionnement local et autonome,
